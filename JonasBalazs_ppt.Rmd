...
sprintf("Módusz, a leggyakrabban elfogadott mennyiség: %s", modusz)
sprintf("Medián, az aukciók felében\naz elfogadott menyiség legalább %s", median(acceptedBonds5, na.rm = TRUE))
